...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins__ = __webpack_require__(60);
...
var app = new Vue({
    ...
    store: new Vuex.Store(__WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */])
});
...
window.Vuex = __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */];
...
var update = __webpack_require__(14)("0cb03232", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-699539b8\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Connect.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-699539b8\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Connect.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    computed: Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["b" /* mapState */])(['apiKey', 'targetUrl']),
                ...
                directives: [
                  {
                    ...
                    rawName: "v-model",
                    value: _vm.storedKey,
                    expression: "storedKey"
                  }
                ],
                staticClass: "form-control input-key-width",
                attrs: {
                  type: "text",
                  id: "apiKey",
                  placeholder: "Enter Api Key"
                },
                domProps: { value: _vm.storedKey },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.storedKey = $event.target.value
                  }
                }
              }),
              _vm._v(" "),
...
Component.options.__file = "assets\\js\\views\\Routes.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-42e1bc00", Component.options)
  } else {
    hotAPI.reload("data-v-42e1bc00", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__RouteSummary_vue__ = __webpack_require__(50);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["b" /* mapState */])(['apiKey', 'targetUrl']),
    created: function created() {
        this.sendRequest();
    },
    data: function data() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        showRoute: function showRoute(id) {
            this.$router.push({ path: '/routes/' + id });
        }
    }
  ...
  return _c(
    ...
    [
      ...
      _vm._l(_vm.routeComponents, function(route) {
        return _c("div", [_c("route-summary", { attrs: { data: route } })], 1)
      })
    ],
    2
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-42e1bc00", module.exports)
  }
}
...
Component.options.__file = "assets\\js\\views\\SingleRoute.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2dd4a09b", Component.options)
  } else {
    hotAPI.reload("data-v-2dd4a09b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(14)("2c829d82", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2dd4a09b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SingleRoute.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2dd4a09b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SingleRoute.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["b" /* mapState */])(['apiKey', 'targetUrl'])),
	...
	methods: {
		sendRequest: function sendRequest(id) {
			...
			axios.get(this.targetUrl + '/api/hooks/' + id, {
				...
				_this.enableButtons();
				_this.data = respose.data.data;
				if (!_this.data.url) {
					_this.noHookDataMessage = "No data for this hook is available";
					return;
				}

				_this.sendToRoute = _this.$store.state.sendToRoutes[_this.data.id];
			}).catch(function (error) {
				_this.enableButtons();
				_this.message = "Sorry, there was an error retrieving data";
			});
		},
		syncRequest: function syncRequest() {
			if (this.data.id) {
				this.disableButtons();
		...
		persistSendToRoute: function persistSendToRoute(route, id) {
			var data = {};
			data.id = id;
			data.path = route;
		...
		makeRequest: function makeRequest() {
			...
			var payload = this.data.body ? this.data.body : null;
			...
			axios({
				...
				_this2.isHtmlResponse = _this2.htmlResponse(response.data);
				_this2.responseStatus = response.status;
				_this2.enableButtons();
			}).catch(function (error) {
				if (error.response) {
					_this2.requestResponse = error.response.data;
					_this2.isHtmlResponse = _this2.htmlResponse(error.response.data);
					_this2.responseStatus = error.response.status;
				} else {
					_this2.responseStatus = '';
					_this2.requestResponse = 'Error sending request: ' + error.message;
				}
...
var render = function() {
  ...
  return _c("div", [
      ...
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-md-10 col-md-offset-1" }, [
          _c("div", { staticClass: "panel panel-default" }, [
            ...
            _vm._v(" "),
            _vm.noHookDataMessage
              ? _c("div", { staticClass: "panel-body" }, [
                  _vm._v(
                    "\n\t\t\t            \t" +
                      _vm._s(_vm.noHookDataMessage) +
                      "\n\t\t\t            "
                  )
                ])
              : _c(
                  "div",
                  { staticClass: "panel-body single-route-body wrap" },
                  [
                    _vm.data.ip
                      ? _c("p", [
                          _c("strong", [_vm._v("IP:")]),
                    ...
                    _vm.data.url
                      ...
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.data.query_string
                      ? _c("p", [
                          _c("strong", [_vm._v("Query String:")]),
                          _vm._v(
                            " " +
                              _vm._s(_vm.data.query_string) +
                              "\n\t\t\t              "
                          )
                        ])
                      : _vm._e(),
                    ...
                    _vm.data.headers
                      ? _c(
                          ...
                          [
                            _vm._m(0),
                            _vm._v(" "),
                            _vm._l(_vm.data.headers, function(value, key) {
                              return _c("p", [
                                _c("mark", [_vm._v(_vm._s(key))]),
                                _vm._v(
                                  ": " +
                                    _vm._s(value) +
                                    "\n\t\t\t              \t"
                        ...
                        _c("form", { staticClass: "form-inline" }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.sendToRoute,
                                expression: "sendToRoute"
                              }
                            ],
                            ...
                            attrs: {
                              type: "text",
                              id: "sendToRoute",
                              placeholder: "Send to route"
                            },
                            domProps: { value: _vm.sendToRoute },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                                }
                                _vm.sendToRoute = $event.target.value
                              }
                            }
                          }),
                          _vm._v(" "),
                          _c(
                            ...
                            {
                              staticClass: "btn btn-primary",
                              attrs: { type: "button", id: "send-request" },
                              on: { click: _vm.makeRequest }
                            },
                            [
                              ...
                              _c("span", {
                                staticClass:
                                  "buttonLoadingImage hiddenButtonElement"
                              })
                            ]
                          ),
                          _vm._v(" "),
                          _vm.data
                            ? _c(
                                "button",
                                {
                                  ...
                                  attrs: { type: "button", id: "sync-request" },
                                  on: { click: _vm.syncRequest }
                                },
                                [
                                  _c("span", { staticClass: "buttonText" }, [
                                    _vm._v("Sync Request")
    ...
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-md-10 col-md-offset-1" }, [
          _vm.requestResponse || _vm.responseStatus
            ? _c("div", { staticClass: "panel panel-default" }, [
                _c("div", { staticClass: "panel-heading" }, [
                  _vm._m(2),
                  _vm._v(" "),
                ...
                _vm.isHtmlResponse
                  ? _c("div", {
                      staticClass: "panel-body single-route-body wrap",
                      domProps: { innerHTML: _vm._s(_vm.requestResponse) }
                    })
                  : _c(
                      "div",
                      { staticClass: "panel-body single-route-body wrap" },
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", [_c("strong", [_vm._v("HEADERS:")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", [_c("strong", [_vm._v("BODY:")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", [_c("strong", [_vm._v("Response")])])
  }
]
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2dd4a09b", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	mutations: {
		saveApiKey: function saveApiKey(state, key) {
			state.apiKey = key;
		},
		setRouteByKey: function setRouteByKey(state, route) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
	methods: {
		...
		showSpinner: function showSpinner(button) {
